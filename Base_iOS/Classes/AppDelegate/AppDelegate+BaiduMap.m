...
- (void)configMapKit {
    ...
    if (![CLLocationManager locationServicesEnabled]) {
        ...
        UIAlertController *alertCtrl = [UIAlertController alertControllerWithTitle:@"提示" message:@"定位失败，请前往“系统设置->我淘网->位置“中开启定位服务" preferredStyle:UIAlertControllerStyleAlert];
