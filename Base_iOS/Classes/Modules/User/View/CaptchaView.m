...
- (void)setUpUIWith:(CGRect)frame
{
    ...
    self.captchaTf = [[TLTextField alloc] initWithFrame:CGRectMake(0, 0, frame.size.width - btnWidth, frame.size.height) leftTitle:@"验证码" titleWidth:100 placeholder:@"请输入验证码"];
