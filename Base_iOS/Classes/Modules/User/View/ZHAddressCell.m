...
//        [self addSubview:self.detailAddressLbl];
        ...
        [self.selectedBtn setImage:[UIImage imageNamed:@"地址-未选中"] forState:UIControlStateNormal];
...
- (void)addressChangeAction:(NSNotification *)noti {
    ...
    if ([obj isEqual:self]) {
        ...
        [self.selectedBtn setImage:[UIImage imageNamed:@"支付选中"] forState:UIControlStateNormal];
