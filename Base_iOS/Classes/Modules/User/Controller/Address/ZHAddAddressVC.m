...
- (void)viewDidLoad {
    ...
    //
    self.detailAddressTf = [[TLTextField alloc] initWithFrame:CGRectMake(0, self.areaTf.yy + margin, kScreenWidth, 50) leftTitle:@"详细地址" titleWidth:leftW placeholder:@"请输入详细地址"];
    ...
    confirmBtn.frame = CGRectMake(15, self.detailAddressTf.yy + 40, kScreenWidth - 2*15, 44);
...
- (void)setAddressType:(AddressType)addressType {
    ...
    self.title = _addressType == AddressTypeAdd ? @"添加地址": @"修改地址";
}
